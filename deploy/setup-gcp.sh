...
echo ""
echo "  Hosting at veluram.com/finance (subpath setup):"
echo "  3. This VM's IP: $(curl -s ifconfig.me 2>/dev/null || echo 'YOUR_IP')"
echo "  4. On veluram.com's server, copy deploy/nginx-veluram-snippet.conf"
echo "     into /etc/nginx/sites-available/veluram.com (inside server {} block)"
echo "  5. Replace FINANCEME_VM_IP in that snippet with the IP above"
echo "  6. On veluram.com: sudo nginx -t && sudo systemctl reload nginx"
echo "  7. Access at: https://veluram.com/finance/"
echo ""
